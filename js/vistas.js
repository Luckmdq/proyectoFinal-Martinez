...
const showpicker = () => {
	...
	abertura.map(elemento => {
		...
		${loginFF?(`<div id="${elemento.nombre}Mod" class="cursor-context-menu font-medium text-red-600 dark:text-red-500">Mod</div>
		`):(`<div id="${elemento.nombre}Add" class=" font-medium text-red-600 dark:text-red-500 hover:underline">Add</div>`)}
